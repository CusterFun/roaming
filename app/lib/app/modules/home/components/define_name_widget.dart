                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: abbreviationController.text.isNotEmpty
                              ? InkWell(
                                  onTap: () => setState(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        obscureText: false,
                        decoration: InputDecoration(
                          hintText: '生成文件的默认名称(建议为驼峰格式,首字母小写,如sysXxxXxxx)',
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: Color(0x00000000),
                              width: 1,
                          ...
                          suffixIcon: packageNameController.text.isNotEmpty
                              ? InkWell(
                                  onTap: () => setState(
                  ...
                  Expanded(
                    child: Theme(
                      ...
                      child: CheckboxListTile(
                        ...
                        onChanged: (newValue) =>
                            setState(() => autoCreateApiToSqlValue = newValue!),
                        title: Text(
                          '创建 API',
                          style: FlutterFlowTheme.of(context).bodyText1,
                        ),
