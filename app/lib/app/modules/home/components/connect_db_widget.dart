...
class ConnectDbWidget extends StatefulWidget {
  ...
  @override
  _ConnectDbWidgetState createState() => _ConnectDbWidgetState();
}

class _ConnectDbWidgetState extends State<ConnectDbWidget> {
  late TextEditingController databaseUrlController;
  ...
  void initState() {
    super.initState();
    databaseUrlController = TextEditingController(text: '127.0.0.1:3306');
    userController = TextEditingController(text: 'root');
    passwordController = TextEditingController(text: 'root1234');
    passwordVisibility = false;
    dbnameController = TextEditingController(text: 'test');
  }
