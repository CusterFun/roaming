...
class LightModeTheme extends FlutterFlowTheme {
  ...
  final Color secondaryBackground = const Color(0xFFF1F4F8);
  final Color primaryText = const Color(0xFF091249);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  final Color tertiaryColor = const Color(0xFFEE8B60);
  final Color alternate = const Color(0xFFFF5963);
  final Color primaryBackground = const Color(0xFF091249);
  final Color secondaryBackground = const Color(0xFF1D2429);
